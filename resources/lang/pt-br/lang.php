	...
	*/
	...
	"errors" => [
		"messages" => [
			...
			"confirmation" => ":attribute não está de acordo com a confirmação",
			"accepted" => "precisa ser aceito",
			"required" => "O campo :attribute não pode ficar vazio",
			"empty" => "não pode ficar vazio",
			"blank" => "não pode ficar vazio",
			"too_long" => ":attribute é muito longo (máximo: :max caracteres)",
			"too_short" => ":attribute é muito curto (mínimo: :min caracteres)",
			"wrong_length" => ":attribute deve ter :count caracteres",
			"long_wrong_length" => ":attribute deve ter no máximo :max caracteres",
			"short_wrong_length" => ":attribute deve ter :min caracteres",
			"taken" => ":attribute não está disponível",
			...
			"cant_link_an_issue_with_a_descendant" => "Uma actividade não pode ser relacionada a uma de suas subactividades",
			"earlier_than_minimum_start_date" => "cannot be earlier than %{date} because of preceding issues",
			"not_a_regexp" => "is not a valid regular expression",
			"open_issue_with_closed_parent" => "An open issue cannot be attached to a closed parent task",
		],
		'unknown' => 'Error Detected! UnknownError'
	],

	// General app lang config
	...
	"notice_failed_to_save_issues" => "Problema ao salvar %{count} actividade(s) de %{total} selecionadas: %{ids}.",
	"notice_no_issue_selected" => "Nenhuma actividade selecionada! Por favor, marque as actividades que você deseja editar.",
	...
	"error_issue_not_found_in_project" => "A actividade não foi encontrada ou não pertence a este projeto",
	"error_no_tracker_in_project" => "Não há um tipo de actividade associado a este projeto. Favor verificar as configurações do projeto.",
	"error_no_default_issue_status" => "A situação padrão para actividade não está definida. Favor verificar sua configuração (Vá em \"Administração -> Situação da actividade\").",
	...
	"mail_subject_reminder" => "%{count} actividade(s) com data prevista para os próximos %{days} dias",
	"mail_body_reminder" => "%{count} actividade(s) para você com data prevista para os próximos %{days} dias:",
	"field_name" => "Nome",
	...
	"field_issue" => "Actividade",
	"field_status" => "Situação",
	"field_notes" => "Notas",
	"field_is_closed" => "Actividade fechada",
	...
	"field_issue_to" => "Actividade relacionada",
	"field_delay" => "Atraso",
	"field_assignable" => "Actividades podem ser atribuídas a este papel",
	...
	"setting_issues_export_limit" => "Limite de exportação das actividades",
	...
	"setting_cross_project_issue_relations" => "Permitir relacionar actividades entre projetos",
	"setting_issue_list_default_columns" => "Colunas na lista de actividades por padrão",
	...
	"setting_display_subprojects_issues" => "Visualizar actividades dos subprojetos nos projetos principais por padrão",
	...
	"label_program" => "Linha estratégica",
	"label_program_plural" => "Linhas estratégicas",
	"label_project_new" => "Novo projeto",
	"label_program_new" => "Novo Linha estratégica",
	...
	"label_issue" => "Actividade",
	"label_issue_new" => "Nova actividade",
	"label_issue_plural" => "Actividades",
	"label_issue_view_all" => "Ver todas as actividades",
	"label_issues_by" => "Actividades por %{value}",
	"label_issue_added" => "Actividade adicionada",
	"label_issue_updated" => "Actividade atualizada",
	...
	"label_role_and_global_permissions" => "Papéis e permissões globais",
	"label_member" => "Membro",
	"label_member_new" => "Novo membro",
	"label_member_plural" => "Membros",
	"label_tracker" => "Tipo de actividade",
	"label_tracker_plural" => "Tipos de actividades",
	"label_tracker_new" => "Novo tipo",
	"label_workflow" => "Fluxo de trabalho",
	"label_issue_status" => "Situação da actividade",
	"label_issue_status_plural" => "Situação das actividades",
	"label_issue_status_new" => "Nova situação",
	"label_issue_category" => "Categoria da actividade",
	"label_issue_category_plural" => "Categorias das actividades",
	...
	"label_reports" => "Relatorios",
	"label_login" => "Entrar",
	"label_logout" => "Sair",
	"label_help" => "Ajuda",
	"label_reported_issues" => "Actividades reportadas",
	"label_assigned_to_me_issues" => "Actividades Atribuídas a mim",
	// "label_assigned_to_me_issues" => "Minhas actividades",
	"label_last_login" => "Última conexão",
	"label_registered_on" => "Registrado em",
	"label_activity" => "Resumo",
	...
	"label_roadmap_no_issues" => "Sem actividades para esta versão",
	...
	"label_issue_tracking" => "Actividades",
	"label_spent_time" => "Tempo gasto",
	"field_spent_hours" => "Tempo gasto",
	...
	"label_watched_issues" => "Actividades observadas",
	"label_related_issues" => "Actividades relacionadas",
	...
	"label_added_time_by" => "Adicionado por :author :time atrás",
	...
	"label_bulk_edit_selected_issues" => "Edição em massa das actividades selecionadas.",
	"label_theme" => "Tema",
	...
	"text_workflow_edit" => "Selecione um papel e um tipo de actividade para editar o fluxo de trabalho",
	"text_are_you_sure" => "Você tem certeza?",
	"text_tip_issue_begin_day" => "actividade inicia neste dia",
	"text_tip_issue_end_day" => "actividade termina neste dia",
	"text_tip_issue_begin_end_day" => "actividade inicia e termina neste dia",
	"text_caracters_maximum" => ":attribute máximo :max caracteres",
	"text_caracters_minimum" => ":attribute deve ter ao menos :min caracteres.",
	...
	"text_issues_ref_in_commit_messages" => "Referenciando actividades nas mensagens de commit",
	"text_issue_added" => "Actividade %{id} incluída (por %{author}).",
	"text_issue_updated" => "Actividade %{id} alterada (por %{author}).",
	"text_wiki_destroy_confirmation" => "Você tem certeza que deseja excluir este wiki e TODO o seu conteúdo?",
	"text_issue_category_destroy_question" => "Algumas actividades (%{count}) estão atribuídas a esta categoria. O que você deseja fazer?",
	"text_issue_category_destroy_assignments" => "Remover atribuições da categoria",
	"text_issue_category_reassign_to" => "Redefinir actividades para esta categoria",
	"text_user_mail_option" => "Para projetos (não selecionados), você somente receberá notificações sobre o que você está observando ou está envolvido (ex. actividades das quais você é o autor ou que estão atribuídas a você)",
	"text_no_configuration_data" => "Os Papéis, tipos de actividades, situação de actividades e fluxos de trabalho não foram configurados ainda.\nÉ altamente recomendado carregar as configurações padrão. Você poderá modificar estas configurações assim que carregadas.",
	...
	"text_issues_destroy_confirmation" => "Você tem certeza que deseja excluir a(s) actividade(s) selecionada(s)?",
	...
	"text_destroy_time_entries_question" => "%{hours} horas de trabalho foram registradas nas actividades que você está excluindo. O que você deseja fazer?",
	...
	"text_reassign_time_entries" => "Atribuir horas reportadas para esta actividade:",
	...
	"enumeration_issue_priorities" => "Prioridade das actividades",
	"enumeration_doc_categories" => "Categorias de documento",
	"enumeration_activities" => "Atividades (registro de horas)",
	"enumeration_partner_type" => "Tipo de Parceiro",
	...
	"permission_edit_issues" => "Editar actividades",
	...
	"permission_add_issues" => "Adicionar actividades",
	...
	"permission_manage_categories" => "Gerenciar categorias de actividades",
	...
	"permission_move_issues" => "Mover actividades",
	"permission_manage_issue_relations" => "Gerenciar relacionamentos de actividades",
	...
	"permission_delete_issues" => "Excluir actividades",
	...
	"label_updated_time_by" => "Atualizado por :author :time",
	...
	"error_can_not_reopen_issue_on_closed_version" => "Uma actividade atribuída a uma versão fechada não pode ser reaberta",
	...
	"error_can_not_delete_project" => "Este projeto não pode ser removido porque tem :issues actividades associadas e/ou :projects subprojetos associados.",
	"button_duplicate" => "Duplicar",
	"button_copy_and_follow" => "Copiar e seguir",
	"label_copy_source" => "Origem",
	"setting_issue_done_ratio" => "Calcular o percentual de conclusão da actividade",
	"setting_issue_done_ratio_issue_status" => "Usar a situação da actividade",
	"error_issue_done_ratios_not_updated" => "O percentual de conclusão das actividades não foi atualizado.",
	"error_workflow_copy_target" => "Por favor, selecione os tipos de actividade e os papéis alvo",
	"setting_issue_done_ratio_issue_field" => "Use o campo da actividade",
	...
	"error_workflow_copy_source" => "Por favor, selecione um tipo de actividade e papel de origem",
	"label_update_issue_done_ratios" => "Atualizar percentual de conclusão das actividades",
	"setting_start_of_week" => "Início da semana",
	"field_watcher" => "Observador",
	"permission_view_issues" => "Ver actividades",
	"label_display_used_statuses_only" => "Somente exibir situações que são usadas por este tipo de actividade",
	...
	"text_own_membership_delete_confirmation" => "Você irá excluir algumas de suas próprias permissões e não estará mais apto a editar este projeto após esta operação.\nVocê tem certeza que deseja continuar?",
	...
	"error_unable_delete_issue_status" => "Não foi possível excluir situação da actividade",
	"label_profile" => "Perfil",
	"permission_manage_subtasks" => "Gerenciar subactividades",
	"field_parent_issue" => "Actividade agrupadora",
	"label_subtask_plural" => "Subactividades",
	...
	"error_can_not_delete_tracker" => "Este tipo de actividade está atribuído a alguma(s) actividade(s) e não pode ser excluído.",
	...
	"label_user_mail_option_only_my_events" => "Somente de actividades que observo ou que esteja envolvido",
	...
	"label_additional_workflow_transitions_for_assignee" => "Transições adicionais permitidas quando o usuário é o responsável pela actividade",
	...
	"label_issues_visibility_own" => "Actividades criadas ou atribuídas ao usuário",
	"field_issues_visibility" => "Visibilidade das actividades",
	"label_issues_visibility_all" => "Todas as actividades",
	"permission_set_own_issues_private" => "Alterar as próprias actividades para públicas ou privadas",
	"field_is_private" => "Privado",
	"permission_set_issues_private" => "Alterar actividades para públicas ou privadas",
	"label_issues_visibility_public" => "Todas as actividades não privadas",
	"text_issues_destroy_descendants_confirmation" => "Isto também irá excluir %{count} subactividade(s).",
	...
	"notice_issue_successful_create" => "Actividade %{id} criada.",
	"label_between" => "entre",
	"setting_issue_group_assignment" => "Permitir atribuições de actividades a grupos",
	"label_diff" => "diff",
	...
	"description_issue_category_reassign" => "Escolha uma categoria de actividades",
	...
	"setting_default_issue_start_date_to_creation_date" => "Usar data corrente como data inicial para novas actividades",
	...
	"setting_commit_cross_project_ref" => "Permitir que actividades de todos os outros projetos sejam refenciadas e resolvidas",
	...
	"notice_issue_update_conflict" => "A actividade foi atualizada por um outro usuário, enquanto você estava editando.",
	"text_issue_conflict_resolution_cancel" => "Descartar todas as minhas mudanças e reexibir %{link}",
	"permission_manage_related_issues" => "Gerenciar actividades relacionadas",
	...
	"notice_user_successful_create" => "Usuário :user criado.",
	...
	"label_copy_subtasks" => "Copiar subactividades",
	"label_copied_to" => "copiada",
	"label_copied_from" => "copiado",
	"label_any_issues_in_project" => "qualquer actividade do projeto",
	"label_any_issues_not_in_project" => "qualquer actividade que não está no projeto",
	...
	"label_no_issues_in_project" => "sem actividades no projeto",
	"label_any" => "todos",
	"label_status" => "Estado",
	"label_last_n_weeks" => "últimas %{count} semanas",
	"setting_cross_project_subtasks" => "Permitir subactividades entre projetos",
	...
	"label_attribute_of_issue" => "Actividade %{name}",
	...
	"setting_link_copied_issue" => "Relacionar actividades copiadas",
	"label_link_copied_issue" => "Relacionar actividades copiadas",
	"label_ask" => "Perguntar",
	...
	"label_search_open_issues_only" => "Somente actividades abertas",
	...
	"permission_copy_issues" => "Copiar actividades",
	...
	"label_parent_task_attributes" => "Atributos das actividades pai",
	"label_parent_task_attributes_derived" => "Calculado das subactividades",
	"label_parent_task_attributes_independent" => "Independente das subactividades",
	...
	"field_total_spent_hours" => "Tempo gasto geral",
	...
	"permission_import_issues" => "Importar actividades",
	"label_import_issues" => "Importar actividades",
	...
	"label_assigned_issues" => "Actividades atribuídas",
	...
	"label_any_open_issues" => "Quaisquer actividades abertas",
	"label_no_open_issues" => "Sem actividades abertas",
	...
	"mail_body_security_notification_change" => null,
	"mail_body_security_notification_change_to" => null,
	"mail_body_security_notification_add" => null,
	"mail_body_security_notification_remove" => null,
	...
	"mail_body_settings_updated" => null,
	...
	"error_no_tracker_allowed_for_new_issue_in_project" => "O projeto não tem nenhum tipo de actividade\npara o qual você pode criar um chamado",
	"label_tracker_all" => "Todos os tipos de actividade",
	"label_new_project_issue_tab_enabled" => "Exibir \"Nova actividade\" em aba",
	...
	"error_no_projects_with_tracker_allowed_for_new_issue" => "Não há projetos com tipos de actividade para os quais você pode criar uma actividade",
	...
	"error_move_of_child_not_possible" => "A subactividade %{child} não pode ser movida para o novo projeto: %{errors}",
	"error_cannot_reassign_time_entries_to_an_issue_about_to_be_deleted" => "O tempo gasto não pode ser alterado numa actividade que será apagada",
	"setting_timelog_required_fields" => "Campos obrigatórios para registro de horas",
	"label_attribute_of_object" => "%{object_name} %{name}",
	"label_user_mail_option_only_assigned" => "Somente de actividades que observo ou que estão atribuídas a mim",
	"label_user_mail_option_only_owner" => "Somente de actividades que observo ou que foram criadas por mim",
	...
	"label_progress_issues" => "Progresso",

	//**Modulos */
	"label_module_issue_tracking" => "Gerenciamento de Actividades",
	"label_module_time_tracking" => "Gerenciamento de tempo",
	"label_module_news" => "Notícias",
	"label_module_documents" => "Documentos",
	"label_module_files" => "Arquivos",
	"label_module_wiki" => "Wiki",
	"label_module_repository" => "Repositório",
	"label_module_boards" => "Fóruns",
	"label_module_calendar" => "Calendário",
	"label_module_gantt" => "Gantt",
	"label_module_budget" => "Orçamento",
	"label_budget" => "Orçamento",
	"label_module_budget" => "Gerenciamento de orçamento",

	/** Main menu module */
	"project_module_issue_tracking" => "Actividades",
	"project_module_time_tracking" => "Tempo gasto",
	...
	"project_module_budget" => "Orçamento",
	"label_finance" => "Orçamento",


	'label_field_format_attachment' => 'Arquivo',
	'label_field_format_bool' => 'Booleano',
	'label_field_format_enumeration' => 'Chave/Lista de valores	',
	'label_field_format_date' => 'Data',
	'label_field_format_float' => 'Decimal',
	'label_field_format_decimal' => 'Numerica',
	'label_field_format_percent' => 'Percentual',
	'label_field_format_int' => 'Inteiro',
	'label_field_format_link' => 'Link',
	'label_field_format_list' => 'Lista',
	'label_field_format_string' => 'Texto',
	'label_field_format_text' => 'Texto longo',
	'label_field_format_user' => 'UserField',
	...
	'label_partner_name' => "Nome do parceiro",
	'label_partner_title_project' => "Titulo do Projecto",
	'label_partner_value_contract' => "Valor do Contracto",
	'label_partner_new' => "Novo parceiro",
	'label_partner_address' => "Endereço do parceiro",
	...
	"label_menu_orcamento" => "Orçamento",
	"label_menu_orcamento_attribute" => "De :attr",
	"label_menu_report" => "Relatório",
	"label_menu_report_attribute" => "De :attr",
	"label_menu_graph" => "Grafico",
	"label_menu_graph_attribute" => "Por :attr",
	"label_tow_way_attributes" => ":attr_1 e :attr_2",

	/** Custom_field validation */
	'custom_field_name_required' => 'O Nome do campo personalizado é obrigatório',

	// News
	'jouranl_news_created' => 'Nova noticia criada',
	'jouranl_news_poject_created' => 'Nova noticia criada para o :project',


	'field_is_aproved' => "Aprovado",
	'text_journal_issue_report' => ":label por :action_by",

	/***
	 * Exceptions Messages
	 */

	'notice_indicator_required' => 'Não foi possível gravar os dados! Um Indicador e necessário.',
	'notice_failed_update' => 'Ocorreu um erro na atualização de dados.',

	'error_can_not_delete_issue' => 'Esta actividade não pode ser excluído, tem sub-actividades associadas.',

	/***
	 * Exceptions Messages
	 */
	"label_timesheet" => "TimeSheet",
	"label_new_timesheet" => "Nova TimeSheet",
	"label_new_tsActivity" => "Nova Actividade da TimeSheet",
];
