@extends('layouts.main', ['title' => 'Editar '.__('lang.label_news')])
@section('content')
                ...
                <div class="col-md-12 col-lg-12 bg-white p-3">
                    <div class="d-flex mb-0">
                        <div class="flex-grow-1">
                            <h5>{{ __('lang.label_news') }} - <span class="text-muted">{{ __('lang.label_news_plural') }} - {{ $news->title }}</span></h5>
                        </div>
                    </div>
                    <hr class="mt-0 mb-3">
                    ...
                    <div class="{{ route('news.update', ['news' => $news->id ]) }}">
