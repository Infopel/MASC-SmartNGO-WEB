@extends('layouts.main', ['title' => __('lang.label_news_plural').' - '. $_project['name']])
@section('content')
    <div class="row m-0 p-2">
        <div class="col-md-12">
            <div class="row">
                @if ($news->project->identifier == 5)
                    <div class="col-md-12">
                ...
                <div class="col-md-12 col-lg-12 bg-white p-3">
                    <div class="d-flex mb-0">
                        ...
                        @if ($_project['status'] !== 5)
                            <div class="">
                                <a href="{{ route('project.new-news', ['project_identifier' => $_project['identifier']]) }} " class="text-success">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="d-md-flex">
                                <div class="flex-grow-1">
                                    <h4>
                                        <a href="{{ route('projects.news', ['project_identifier' => $item->project->identifier]) }}">{{ __('lang.label_news_plural') }}</a> » {{ $news->title }}
