                ...
                <div class="card-block p-3 rounded">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h5>
                                <a href="{{ route('budget.config.index') }}"> Tipo de Despesa </a> » Valores Base
                            </h5>
                        </div>
                    </div>

                    <div class="">
                        <form action="{{ route('budget.config.store_valor_base') }}" method="POST">
                            @csrf
                            <div class="form-row align-items-center">
                                <div class="col-auto my-1">
                                    ...
                                    <select class="custom-select custom-select-sm mr-sm-2"  name="tipo_despesa">
                                        ...
                                        @foreach ($budget_trackers as $trackers)
                                            <option value="{{ $trackers->id }}">{{ $trackers->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-auto my-1">
                                ...
                                <div class="col-auto my-1">
                                    <div class="">
                                        <input type="text" value="" class="form-control form-control-sm" placeholder="Valor base" input_type="float" name="value">
                                    </div>
                                </div>
                                <div class="col-auto my-1">
