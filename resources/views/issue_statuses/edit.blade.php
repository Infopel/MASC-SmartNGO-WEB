@extends('layouts.main', ['title' =>  $data['issues_status']->name .' - '.__('lang.label_issue_status_plural')])
@section('content')
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h5>
                                ...
                                {{ $data['issues_status']->name }}
                            </h5>
                        </div>
                    </div>
                    <form action="{{ route('issue_statuses.update', ['id' => $data['issues_status']['id']]) }}" method="POST">
                        @csrf
                        <div class="row m-0">
