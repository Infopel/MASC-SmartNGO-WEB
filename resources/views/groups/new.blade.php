@extends('layouts.main', ['title' => __('lang.label_group_new').' - '.__('lang.label_group_plural') ])
@section('content')
            ...
            <div class="h-100">
                <div class="row h-100 rounded">
                    <div class="card-block p-3 rounded">
                        ...
                        <h5><a href="{{ route('groups.index') }}">{{ __('lang.label_group_plural') }}</a> » {{ __('lang.label_group_new') }}</h5>

                        <div class="">
                            <form action="{{ route('groups.new') }}" method="POST">
                                @csrf
                                <div class="row">
